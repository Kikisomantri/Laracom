            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col mt-10 mb-10">
                    ...
                    <div class="header-links">
                        <a href="track-order.html"><img src="{{asset('themes/frontend/assets/images/icons/car.png')}}" alt="Car Icon"> <span>Track your order</span></a>
                        <a href="store.html"><img src="{{asset('themes/frontend/assets/images/icons/marker.png')}}" alt="Car Icon"> <span>Locate Store</span></a>
                ...
                <div class="col order-2 order-xs-2 order-lg-12 mt-10 mb-10">
                    ...
                    <div class="header-account-links">
                        ...
                        <a href="login.html" data-toggle="modal" data-target="#myModal"><i class="icofont icofont-login d-none"></i> <span>Login</span></a>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col mt-15 mb-15">
                    ...
                    <div class="header-logo">
                        <a href="index.html">
                            <img src="{{asset('themes/frontend/assets/images/logo.png')}}" alt="Laracom - Electronics eCommerce Bootstrap4 HTML Template">
                            <img class="theme-dark" src="{{asset('themes/frontend/assets/images/logo-light.png')}}" alt="E&E - Electronics eCommerce Bootstrap4 HTML Template">
                        </a>
                    </div><!-- Logo End -->
                </div>
