                ...
                <div class="col mb-90">
                    <div class="footer-widget text-center">
                        <div class="footer-logo">
                            <img src="{{asset('themes/frontend/assets/images/logo.png')}}" alt="E&E - Electronics eCommerce Bootstrap4 HTML Template">
    ...
    <div class="footer-bottom-section section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="footer-payments-image"><img src="{{asset('themes/frontend/assets/images/payment-support.png')}}" alt="Payment Support Image"></div>
                </div>
